...
List<ProviderAppointmentListResponse> ProviderAppointmentListResponseFromJsonList(dynamic str) => List<ProviderAppointmentListResponse>.from(json.decode(str).map((x) => ProviderAppointmentListResponse.fromJson(x)));

String ProviderAppointmentListResponseToJsonList(List<ProviderAppointmentListResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProviderAppointmentListResponse {
