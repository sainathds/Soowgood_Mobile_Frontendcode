...
List<ProviderCancelAppointmentResponse> ProviderCancelAppointmentResponseFromJsonList(dynamic str) => List<ProviderCancelAppointmentResponse>.from(json.decode(str).map((x) => ProviderCancelAppointmentResponse.fromJson(x)));

String ProviderCancelAppointmentResponseToJsonList(List<ProviderCancelAppointmentResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProviderCancelAppointmentResponse {
