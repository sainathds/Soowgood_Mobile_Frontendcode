...
List<ProviderPatientListResponse> ProviderPatientListResponseFromJsonList(dynamic str) => List<ProviderPatientListResponse>.from(json.decode(str).map((x) => ProviderPatientListResponse.fromJson(x)));

String ProviderPatientListResponseToJsonList(List<ProviderPatientListResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));


class ProviderPatientListResponse {
