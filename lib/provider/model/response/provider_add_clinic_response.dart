class ProviderAddClinicResponse {
  String? id;
  String? name;
  ...
  ProviderAddClinicResponse({this.id, this.name, this.optionalAddress, this.currentAddress, this.city, this.state, this.country, this.postalCode, this.imageUrl, this.imageUrlOptionalOne, this.imageUrlOptionalTwo, this.imageUrlOptionalThree, this.userId, this.createdBy, this.createdOn, this.updatedBy, this.updatedOn, this.isDeleted, this.isActive});

  ProviderAddClinicResponse.fromJson(Map<String, dynamic> json) {
    this.id = json["id"];
    this.name = json["name"];
