...
List<ProviderDashboardAppointmentsResponse> ProviderAppointmentsResponseFromJsonList(dynamic str) => List<ProviderDashboardAppointmentsResponse>.from(json.decode(str).map((x) => ProviderDashboardAppointmentsResponse.fromJson(x)));

String ProviderAppointmentsResponseToJsonList(List<ProviderDashboardAppointmentsResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProviderDashboardAppointmentsResponse {
