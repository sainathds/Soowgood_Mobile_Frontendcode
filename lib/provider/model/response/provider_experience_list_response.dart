...
List<ProviderExperienceListResponse> ProviderExperienceListResponseFromJsonList(dynamic str) => List<ProviderExperienceListResponse>.from(json.decode(str).map((x) => ProviderExperienceListResponse.fromJson(x)));

String ProviderExperienceListResponseToJsonList(List<ProviderExperienceListResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));


class ProviderExperienceListResponse {
  String? _id;
  ...
  ProviderExperienceListResponse(
      {String? id,
        String? hospitalName,
        Null? description,
        String? designation,
  ...
  ProviderExperienceListResponse.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
