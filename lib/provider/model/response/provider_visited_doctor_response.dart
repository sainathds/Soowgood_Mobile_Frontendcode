...
List<ProviderVisitedDoctorListResponse> ProviderVisitedDoctorListResponseFromJsonList(dynamic str) => List<ProviderVisitedDoctorListResponse>.from(json.decode(str).map((x) => ProviderVisitedDoctorListResponse.fromJson(x)));

String ProviderVisitedDoctorListResponseToJsonList(List<ProviderVisitedDoctorListResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProviderVisitedDoctorListResponse {
