class UploadProfilePicResponse {
  ...
  Null? get otherEmail => _otherEmail;
  set otherEmail(Null? otherEmail) => _otherEmail = otherEmail;
  String? get registrationDate => _registrationDate;
  set registrationDate(String? registrationDate) =>
      _registrationDate = registrationDate;
  Null? get othersMemberEmail => _othersMemberEmail;
  set othersMemberEmail(Null? othersMemberEmail) =>
      _othersMemberEmail = othersMemberEmail;
  String? get profilePicture => _profilePicture;
  set profilePicture(String? profilePicture) =>
      _profilePicture = profilePicture;
  Null? get firstName => _firstName;
  set firstName(Null? firstName) => _firstName = firstName;
  Null? get lastName => _lastName;
  set lastName(Null? lastName) => _lastName = lastName;
  ...
  Null? get facebook => _facebook;
  set facebook(Null? facebook) => _facebook = facebook;
  Null? get twitter => _twitter;
  set twitter(Null? twitter) => _twitter = twitter;
  Null? get status => _status;
  set status(Null? status) => _status = status;
  Null? get bloodGroup => _bloodGroup;
  set bloodGroup(Null? bloodGroup) => _bloodGroup = bloodGroup;
  ...
  Null? get userActivities => _userActivities;
  set userActivities(Null? userActivities) => _userActivities = userActivities;
  ...
  Null? get lockoutEnd => _lockoutEnd;
  set lockoutEnd(Null? lockoutEnd) => _lockoutEnd = lockoutEnd;
  ...
  UploadProfilePicResponse.fromJson(Map<dynamic, dynamic> json) {
