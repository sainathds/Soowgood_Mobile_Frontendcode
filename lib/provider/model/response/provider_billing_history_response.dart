...
List<ProviderBillingHistoryResponse> ProviderBillingHistoryResponseFromJsonList(dynamic str) => List<ProviderBillingHistoryResponse>.from(json.decode(str).map((x) => ProviderBillingHistoryResponse.fromJson(x)));

String ProviderBillingHistoryResponseToJsonList(List<ProviderBillingHistoryResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProviderBillingHistoryResponse {
