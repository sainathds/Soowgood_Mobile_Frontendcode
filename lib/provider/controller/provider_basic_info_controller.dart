...
class ProviderBasicInfoController extends GetxController{
  ...
  ///
  ///
  /// use to save or update profile data using
  /// Users/updateUserProfile Api
  void getBasicInfoResponse() async{
    ...
    requestModel.state = '';
    requestModel.city = '';
    requestModel.usertype = 'Provider';


    ProviderBasicInfoResponse? responseModel = await providerRepository.hitUpdateBasicInfoApi(requestModel);
    ...
    if(responseModel != null){
      if(responseModel.success == '1'){
        ...
        ProviderGlobal.isBasicInfoBack = true;
        showDialog(
          context: Get.context!,
          builder: (BuildContext context1) =>
              CustomDialog(
                  ...
                  img: successImage,
                  title: "",
                  description: isUpdated? 'Basic Info Updated Successfully': responseModel.message! ,
                  buttonText: 'Ok',
