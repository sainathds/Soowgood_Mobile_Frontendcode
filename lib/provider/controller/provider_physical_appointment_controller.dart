...
class ProviderPhysicalAppointmentController extends GetxController{
  ...
  var physicalAppointmentList = <ProviderAppointmentListResponse>[].obs;
  var newPhysicalAppointmentList = <ProviderAppointmentListResponse>[].obs;

  var appointmentTypeId = ''.obs;

  ///*
  ///
  /// get Bookings/getProviderAppointments Api Response
  /// to get appointment list of particular clinic
   void getAppointmentListResponse() async{
    ...
    if(responseModel != null && responseModel.isNotEmpty){
      physicalAppointmentList.clear();
      physicalAppointmentList.value = responseModel;
    }else{
      physicalAppointmentList.clear();
    }
  }
  ...
  void getCheckCancelAppointmentResponse(int index) async{
    ...
    requestModel.id = physicalAppointmentList[index].id;
  ...
  void getCancelAppointmentResponse(int index) async{
    ...
    requestModel.appointmentSettingId = physicalAppointmentList[index].appointmentSettingId;
    requestModel.beneficiaryComment = physicalAppointmentList[index].beneficiaryComment;
    requestModel.id = physicalAppointmentList[index].id;
    requestModel.isBookingCancelledByReceiver = true;
    requestModel.serviceProviderId = physicalAppointmentList[index].serviceProviderId;
