...
class ProviderClinicAppointmentController extends GetxController{
  ...
  var clinicAppointmentList = <ProviderAppointmentListResponse>[].obs;
  var newClinicAppointmentList = <ProviderAppointmentListResponse>[].obs;
  ...
  void getAppointmentListResponse() async{
    ...
    if(responseModel != null && responseModel.isNotEmpty){
      clinicAppointmentList.clear();
      clinicAppointmentList.value = responseModel;
    }else{
      clinicAppointmentList.clear();
    }
  }
  ...
  void getCheckCancelAppointmentResponse(int index) async{
    ...
    requestModel.id = clinicAppointmentList[index].id;
  ...
  void getCancelAppointmentResponse(int index) async{
    ...
    requestModel.appointmentSettingId = clinicAppointmentList[index].appointmentSettingId;
    requestModel.beneficiaryComment = clinicAppointmentList[index].beneficiaryComment;
    requestModel.id = clinicAppointmentList[index].id;
    requestModel.isBookingCancelledByReceiver = true;
    requestModel.serviceProviderId = MySharedPreference.getString(KeyConstants.keyUserId);
    requestModel.serviceReceiverId =   clinicAppointmentList[index].serviceReceiverId;
