...
import 'package:soowgood/benificiary/controller/all_appointment_controller.dart';
...
import '../../common/dialog/ask_dialog.dart';
import '../../common/dialog/ok_dialog.dart';
import '../../common/resources/my_assets.dart';
import '../../common/resources/my_colors.dart';

class AllAppointmentTab extends StatefulWidget {
  const AllAppointmentTab({Key? key}) : super(key: key);

  @override
  _AllAppointmentTabState createState() => _AllAppointmentTabState();
}

class _AllAppointmentTabState extends State<AllAppointmentTab> {

  AllAppointmentController getXController = Get.put(AllAppointmentController());
  ...
  void initState() {
    ...
    getXController.refreshPage = refreshPage; //step 3
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            getRecentAppointment():const SizedBox(),
          ],
        )
      );
    });
