...
import 'package:soowgood/benificiary/controller/recent_appointment_controller.dart';
...
class RecentAppointmentTab extends StatefulWidget {
  const RecentAppointmentTab({Key? key}) : super(key: key);

  @override
  _RecentAppointmentTabState createState() => _RecentAppointmentTabState();
}

class _RecentAppointmentTabState extends State<RecentAppointmentTab> {
  RecentAppointmentController getXController = Get.put(RecentAppointmentController());
  ...
  void compairTime(int index) {
    log('VDO_CALL_APT_ID Patient ${getXController.appointmentList[index].id!}');
