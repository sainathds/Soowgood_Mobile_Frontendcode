...
List<BeneficiaryCancelAppointmentResponse> BeneficiaryCancelAppointmentResponseFromJsonList(dynamic str) => List<BeneficiaryCancelAppointmentResponse>.from(json.decode(str).map((x) => BeneficiaryCancelAppointmentResponse.fromJson(x)));

String BeneficiaryCancelAppointmentResponseToJsonList(List<BeneficiaryCancelAppointmentResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class BeneficiaryCancelAppointmentResponse {
