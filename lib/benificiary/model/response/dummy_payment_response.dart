class DummyPaymentResponse {
  ...
  DummyPaymentResponse({this.verificationotp, this.success, this.message, this.email, this.phonenumber, this.userRole, this.currentverificationotp, this.userName, this.id, this.concurrencyStamp, this.profilePicture, this.code, this.accessToken, this.elements});

  DummyPaymentResponse.fromJson(Map<dynamic, dynamic> json) {
