...
List<BeneficiaryAddEditBookingResponse> BeneficiaryAddEditBookingResponseFromJsonList(dynamic str) => List<BeneficiaryAddEditBookingResponse>.from(json.decode(str).map((x) => BeneficiaryAddEditBookingResponse.fromJson(x)));

String BeneficiaryAddEditBookingResponseToJsonList(List<BeneficiaryAddEditBookingResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class BeneficiaryAddEditBookingResponse {
