...
List<AppointmentListResponse> AppointmentListResponseFromJsonList(dynamic str) => List<AppointmentListResponse>.from(json.decode(str).map((x) => AppointmentListResponse.fromJson(x)));

String AppointmentListResponseToJsonList(List<AppointmentListResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class AppointmentListResponse {
  ...
  dynamic bookingtype;
  String? tentativeBookingDate;
  int? isPaymentDone;
  int? isnewpatient;
  String? appointmentStatus;
  String? appointmentTypeName;
  dynamic lastApointmentDate;
  String? tentativeAppointmentDate;
