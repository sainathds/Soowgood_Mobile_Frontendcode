...
List<UpdatePatientDataResponse> UpdatePatientDataResponseFromJsonList(dynamic str) => List<UpdatePatientDataResponse>.from(json.decode(str).map((x) => UpdatePatientDataResponse.fromJson(x)));

String UpdatePatientDataResponseToJsonList(List<UpdatePatientDataResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));


class UpdatePatientDataResponse {
