...
List<CancelAppointmentByPatientResponse> CancelAppointmentByPatientResponseFromJsonList(dynamic str) => List<CancelAppointmentByPatientResponse>.from(json.decode(str).map((x) => CancelAppointmentByPatientResponse.fromJson(x)));

String CancelAppointmentByPatientResponseToJsonList(List<CancelAppointmentByPatientResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));


class CancelAppointmentByPatientResponse {
