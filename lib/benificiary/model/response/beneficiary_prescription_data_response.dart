...
List<BeneficiaryPrescriptionDataResponse> BeneficiaryPrescriptionDataResponseFromJsonList(dynamic str) => List<BeneficiaryPrescriptionDataResponse>.from(json.decode(str).map((x) => BeneficiaryPrescriptionDataResponse.fromJson(x)));

String BeneficiaryPrescriptionDataResponseToJsonList(List<BeneficiaryPrescriptionDataResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class BeneficiaryPrescriptionDataResponse {
