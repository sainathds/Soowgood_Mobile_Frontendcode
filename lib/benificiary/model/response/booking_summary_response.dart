...
List<BookingSummaryResponse> BookingSummaryResponseFromJsonList(dynamic str) => List<BookingSummaryResponse>.from(json.decode(str).map((x) => BookingSummaryResponse.fromJson(x)));

String BookingSummaryResponseToJsonList(List<BookingSummaryResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class BookingSummaryResponse {
  ...
  BookingSummaryResponse.fromJson(Map<String, dynamic> json) {
