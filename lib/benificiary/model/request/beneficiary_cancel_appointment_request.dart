...
class BeneficiaryCancelAppointmentRequest {
  ...
  BeneficiaryCancelAppointmentRequest({this.appointmentSettingId, this.beneficiaryComment, this.id, this.isBookingCancelledByReceiver, this.serviceProviderId, this.serviceReceiverId});

  BeneficiaryCancelAppointmentRequest.fromJson(Map<String, dynamic> json) {
