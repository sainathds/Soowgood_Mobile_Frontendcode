class CancelAppointmentByPatientRequest {
  ...
  CancelAppointmentByPatientRequest({this.appointmentSettingId, this.beneficiaryComment, this.id, this.isBookingCancelledByReceiver, this.serviceProviderId, this.serviceReceiverId});

  CancelAppointmentByPatientRequest.fromJson(Map<String, dynamic> json) {
